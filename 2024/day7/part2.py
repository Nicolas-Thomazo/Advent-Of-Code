...
def compute(current_sum: int, operation: str, number: int):
    if operation == "+":
        ...
        return int(str(current_sum) + str(number))
    else:
...
print(f"AOC Day 7 - part 2: result={total_calibration}")
print("--- %s seconds ---" % (time.time() - start_time))
# 12.8s avant d'ajouter la vérification sur la somme qui dépasse la valeur max
# 5.8s après avoir ajouter la vérification
# res=140575048428831
# %%
